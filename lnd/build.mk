...
LND_REPO_PATCH=cat $(LND_SOURCE_DIR)/assets/debian/lnd-control >> $(LND_BUILD_DIR)/debian/control && cp $(LND_SOURCE_DIR)/assets/debian/lnd.install $(LND_BUILD_DIR)/debian/ && cp $(LND_SOURCE_DIR)/assets/debian/lncli.install $(LND_BUILD_DIR)/debian/ && cp $(LND_SOURCE_DIR)/assets/debian/lncli.postinst $(LND_BUILD_DIR)/debian/ && cp $(LND_SOURCE_DIR)/assets/debian/lncli.prerm $(LND_BUILD_DIR)/debian/
