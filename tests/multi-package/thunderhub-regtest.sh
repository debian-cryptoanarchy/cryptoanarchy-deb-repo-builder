...
sudo apt install -y bitcoin-regtest bitcoin-cli lnd thunderhub python3-selenium selfhost-clearnet lncli
...
# Thunderhub crashes with too much money
...
bitcoin_cli sendtoaddress "$sys_lnd_deposit_addr" 4.2
bitcoin_cli generatetoaddress 6 "$bitcoind_deposit_addr"
sleep 10
