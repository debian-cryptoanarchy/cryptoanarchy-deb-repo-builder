...
- [x] bitcoind-sv
- [x] bitcoin-sv-mainnet
- [x] bitcoin-sv-pruned-mainnet (provides bitcoin-chain-mode-mainnet) DO NOT DEPEND ON THIS ONE!!!
- [x] bitcoin-sv-fullchain-mainnet (provides bitcoin-chain-mode-mainnet)
- [x] bitcoin-sv-txindex-mainnet (provides bitcoin-chain-mode-mainnet)
- [x] bitcoin-sv-chain-mode-mainnet makes sure to consistently select pruned/non-pruned/txindex
- [x] bitcoin-sv-zmq-mainnet
- [x] bitcoin-sv-cli (with a wrapper that uses bitcoin-mainnet by default)
