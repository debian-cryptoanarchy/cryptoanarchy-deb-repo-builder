...
TOR_EXTRAS_REPO_PATCH=cp $(addprefix $(TOR_EXTRAS_SOURCE_DIR)/assets/debian/tor-hs-patch-config., install preinst postinst postrm) $(TOR_EXTRAS_BUILD_DIR)debian/
